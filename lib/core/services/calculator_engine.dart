...
int customGlassMl = 250;
  int customBottleMl = 500;
  int customSipperMl = 1000;
...
bool _isHydrationConfigured = false;
  bool get isHydrationConfigured => _isHydrationConfigured;
void updateContainerSizes(int glass, int bottle, int sipper) {
    customGlassMl = glass;
    customBottleMl = bottle;
    customSipperMl = sipper;


    _isHydrationConfigured = true;
    notifyListeners();
  }
